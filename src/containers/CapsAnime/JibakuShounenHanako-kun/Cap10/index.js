            ...
            <div className="container-caps">
                <div className="container-caps-B">
                    <div className="container-video">
                        ...
                        <div className="video">
                            <iframe src="https://www.fembed.com/v/7m6l3bg6k-d06j4" frameborder="0" title="Jibaku Shounen Hanako-kun Cap.10"></iframe>
                        </div>
                        
                        <div className="title-cap">
                            <h1>
                                Jibaku Shounen Hanako-kun Cap.10
                            </h1>
                        </div>

                        <div className="change-cap">
                            <Link to={urlDefecto + "9"} className="link-caps">
...
export default JibakuShounenCap10