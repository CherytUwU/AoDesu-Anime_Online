            ...
            <div className="container-caps">
                <div className="container-caps-B">
                    <div className="container-video">
                        ...
                        <div className="video">
                            <iframe src="https://www.fembed.com/v/10w62hjzrnmz8zz" frameborder="0" title="Jibaku Shounen Hanako-kun Cap.4"></iframe>
                        </div>
                        
                        <div className="title-cap">
                            <h1>
                                Jibaku Shounen Hanako-kun Cap.4
                            </h1>
                        </div>

                        <div className="change-cap">
                            <Link to={urlDefecto + "3"} className="link-caps">
...
export default JibakuShounenCap4