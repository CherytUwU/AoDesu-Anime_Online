            ...
            <div className="container-caps">
                <div className="container-caps-B">
                    <div className="container-video">
                        ...
                        <div className="video">
                            <iframe src="https://www.fembed.com/v/6z4qpf04k4dkm08" frameborder="0" title="Jibaku Shounen Hanako-kun Cap.7"></iframe>
                        </div>
                        
                        <div className="title-cap">
                            <h1>
                                Jibaku Shounen Hanako-kun Cap.7
                            </h1>
                        </div>

                        <div className="change-cap">
                            <Link to={urlDefecto + "6"} className="link-caps">
...
export default JibakuShounenCap7