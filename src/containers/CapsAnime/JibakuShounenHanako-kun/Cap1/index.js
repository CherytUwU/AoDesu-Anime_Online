            ...
            <div className="container-caps">
                <div className="container-caps-B">
                    <div className="container-video">
                        ...
                        <div className="video">
                            <iframe src="https://www.fembed.com/v/6z4qpf04kx-q8-2" frameborder="0" title="Jibaku Shounen Hanako-kun Cap.1"></iframe>
                        </div>
                        
                        <div className="title-cap">
                            <h1>
                                Jibaku Shounen Hanako-kun Cap.1
                            </h1>
                        </div>
...
export default JibakuShounenCap1