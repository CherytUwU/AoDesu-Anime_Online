            ...
            <div className="container-caps">
                <div className="container-caps-B">
                    <div className="container-video">
                        ...
                        <div className="video">
                            <iframe src="https://www.fembed.com/v/7m6l3bg6npk4qrj" frameborder="0" title="Seishun Buta Yarou wa Bunny Girl Senpai no Yume wo Minai Cap. 2" allowfullscreen></iframe>
                        </div>

                        <div className="title-cap">
                            <h1>
                                Seishun Buta Yarou wa Bunny Girl Senpai no Yume wo Minai Cap. 2
                            </h1>
                        </div>

                        <div className="change-cap">
                            <Link to={urlDefecto + "1"} className="links-caps">
...
export default BunnyGirlSenpaiCap2