            ...
            <div className="container-caps">
                <div className="container-caps-B">
                    <div className="container-video">
                        ...
                        <div className="video">
                            <iframe src="https://www.fembed.com/v/mg065c5l3z8gnzd" frameborder="0" title="Boku no Hero Cap. 1" allowfullscreen></iframe>
                        </div>
...
export default BokuNoHeroSeasonOneCap7