            ...
            <div className="container-caps">
                <div className="container-caps-B">
                    <div className="container-video">
                        ...
                        <div className="video">
                            <iframe src="https://www.fembed.com/v/42w10bz7yg5gp4x" frameborder="0" title="Boku no Hero Cap. 1" allowfullscreen></iframe>
                        </div>
...
export default BokuNoHeroSeasonOneCap9