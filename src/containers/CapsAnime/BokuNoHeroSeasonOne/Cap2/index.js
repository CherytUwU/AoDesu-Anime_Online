            ...
            <div className="container-caps">
                <div className="container-caps-B">
                    <div className="container-video">
                        ...
                        <div className="video">
                            <iframe src="https://www.fembed.com/v/em8zrb-4lg5-4yw" frameborder="0" title="Boku no Hero Cap. 1" allowfullscreen></iframe>
                        </div>
...
export default BokuNoHeroSeasonOneCap2